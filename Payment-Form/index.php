...
if ($_POST) {
  Stripe::setApiKey("sk_test_3pWpDx6Kf6edWAnCBmyu5QDd");
  ...
  try {
    ...
    Stripe_Charge::create(array("amount" => $charge_amount,
                                "currency" => "usd",
  ...
  <fieldset>
    ...
    <div class="panel panel-success">
      ...
      <div class="panel-body">
        <p>Your card will be charged <?=$charge_amount;?> after submit.</p>
